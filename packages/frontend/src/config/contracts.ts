...
// Deployed contract address on Cedra testnet (holdem_v2 profile)
export const CONTRACT_ADDRESS = import.meta.env.VITE_CONTRACT_ADDRESS || "0x88d4e49b9fbcd8abd778f94eba6cefe74f1e63e16b9623a26cf3e4f0fcee665f";
